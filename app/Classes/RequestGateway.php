...
class RequestGateway extends AuthGateway {
    ...
    private function translateHeaders($header){
        ...
        if (!isset($header['X-CR-Request-ID'])){
            $header['X-CR-Request-ID'] = 'YzUzYzcxNjJkODhjMWEzZGZjNWE4Yzc2MWNkYTZkYzU5MTllZDJhOTYyMmFkZDY1ZDUwZGIwMjI4YTNkYzFhNQ==';
        }

        if (!isset($header['X-CR-Connect-ID'])){
            $header['X-CR-Connect-ID'] = base64_encode(\Session::getId() . 'U');
        }
