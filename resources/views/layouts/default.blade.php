...
<html lang="{{ $lang=='kh'?'km-kh':'en-us' }}">
	...
	<body class="no-underline-link no-outline lang_{{ $lang }}" ng-app="app">
		...
		@if(App::environment('local'))
			...
			{{-- <script type="text/javascript" src="{{ asset('vendors/imagesloaded/imagesloaded.pkgd.mi/n.js') }}"></script> --}}
			...
			{{-- <script type="text/javascript" src="{{ asset('js/hh/select-hotel.js') }}"></script>
			<script type="text/javascript" src="{{ asset('js/hh/hotel-review.js') }}"></script>
			<script type="text/javascript" src="{{ asset('js/hh/contact-us.js') }}"></script> --}}


			<script type="text/javascript" src="{{ asset('js/hh/main.js') }}"></script>
		@else
